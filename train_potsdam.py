...
dir_checkpoint = 'checkpoints_potsdam/'
...
if __name__ == '__main__':
    ...
    if args.model == 'unet':
        ...
        net = UNetFormer(in_channels=args.in_ch, num_classes=1)
    else:
